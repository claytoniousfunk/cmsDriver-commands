...
# with command line options: --filein file:signal_RAW.root --python_filename signal_RECO.py --fileout file:signal_RECO.root --step RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --datatier MINIAODSIM --eventcontent MINIAODSIM --mc --conditions 140X_mcRun3_2024_realistic_v3 --nThreads 4 --geometry DB:Extended --era Run3 --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:signal_RAW.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:signal_RECO.root'),
